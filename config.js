module.exports = {
	...
	adminId: "585484131605938194", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "1023981836835246201", //- Bot's Token
	clientId: process.env.clientId || "1023981836835246201", //- ID of the bot
	clientSecret: process.env.clientSecret || "Hi9OhU9q1P6vX28JXdBViCOGQ0Z5sBwF", //- Client Secret of the bot
